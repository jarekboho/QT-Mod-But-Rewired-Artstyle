...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		grpWeekCharacters.add(new MenuCharacter(50, 0, 0.59, false, 'qt'));
		grpWeekCharacters.add(new MenuCharacter(150, 80, 1.0, true, 'bf'));
		grpWeekCharacters.add(new MenuCharacter(200, 80, 1.0, true, 'gf'));
	...
	function selectWeek()
	{
		if (weekUnlocked[curWeek])
		{
			if (stopspamming == false)
			{
				...
				if(grpWeekCharacters.members[0].animation.name == 'idle')
				{
				grpWeekCharacters.members[0].animation.play('confirm');
				grpWeekCharacters.members[0].animOffsets2[0] = 122;
				grpWeekCharacters.members[0].animOffsets2[1] = -81;
				}
				stopspamming = true;
			}
